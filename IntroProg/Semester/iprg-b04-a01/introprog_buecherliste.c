...
// setzt den array slot MAX_STR auf NULL, damit das Array Ende erkannt wird
...
element *construct_element(char *title, char *author, int year, long long int isbn) { 
    ...
    book->title[MAX_STR-1] = '\0'; // set array slot 255 equal to NULL: mark end of array
